...
$prm = query("SELECT * FROM kategori WHERE id = $id")[0];
...
<body>
    ...
    <form method="POST" action="">
        ...
        <div>
            ...
            <input type="text" name="nama" id="nama" required="" value="<?= $prm["namakategori"];  ?>">

            <label for="deskripsi">Category Description :</label>
            <textarea name="deskripsi" required="" id="deskripsi"><?= $prm["deskripsi"]; ?></textarea>
